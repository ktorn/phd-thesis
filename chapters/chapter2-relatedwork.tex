...
Acquisition is the process that a cultural heritage institution takes to obtain an artifact for conservation. It is normally divided into 3 phases:
...
\begin{enumerate}
    ...
    \item  \textbf{Post-acquisition}: 
\end{enumerate}

\cite{ahtilaAcquiringMediaArt1998}
...
talk about Flash, games, webrecorder browser emulator, etc
