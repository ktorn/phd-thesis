...
\textbf{cryptoart} - this refers to any artwork which is registered on a blockchain as an NFT, and which exists purely in digital format, without any physical components. This last assumption is important, as the conservation of physical artifacts requires a very different approach to their digital counterparts.
...
These terms will be further unpacked in \autoref{chap:related_work}.
